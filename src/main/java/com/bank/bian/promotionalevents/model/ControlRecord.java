package com.bank.bian.promotionalevents.model;
...
/**
 * The BIAN control record for this service domain: "Promotional Event Operating Session".
 *
 ...
 * to its asset type (Promotional Event). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Promotional Event Operating Session";
